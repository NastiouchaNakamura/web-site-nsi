...
??? "Thème 3 - Conception et analyse d'algorithmes"
    ...
    Lorsque l'on cherche à **résoudre informatiquement un problème**, on cherche
    à **trouver un algorithme adapté** qui soit **correct**, **fini**,
    **rapide** et **efficace**. Mais tous les algorithmes ne sont pas forcément
    rapides, efficaces, ni même finis ou corrects...

    Dans ce thème, nous voyons les **stratégies** adoptées par certains
    algorithmes pour résoudre des problèmes **de manière systématique**, et
    notamment la notion que **plusieurs stratégies sont applicables** au même
    problème pour la même solution. De plus, on s'intéresse à **déterminer la
    complexité** et la correction des algorithmes, ce qui n'est pas toujours
    facile.
...
??? "Thème 4 - Données en tables et bases de données"
    ...
    L'information automatique aussi appelée informatique
